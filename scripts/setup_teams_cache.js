...
if (!supabaseUrl || !supabaseKey) {
  ...
  console.log('Please ensure NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY (or NEXT_PUBLIC_SUPABASE_ANON_KEY) are set')
  process.exit(1)
}
...
async function testConnection() {
  ...
  try {
    // Simple test query that should work regardless of table existence
